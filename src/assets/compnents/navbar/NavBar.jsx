...
function NavBar() {
  return (
   ...
   <div>
<nav class="bg-white  w-full z-20 top-0 start-0 border-b border-gray-200 shadow-sm h-20 max-[640px]:h-12 ">


  <div class="max-w-screen flex flex-wrap items-center justify-between mx-auto lg:p-4 p-1">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div className='flex gap-5 me-4 items-center'>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
  <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clipRule="evenodd" />
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col p-4 md:p-0 mt-4 text-[18px] font-[500] border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white lg:gap-20 lg:ml-[-80px] ">
        <li>
